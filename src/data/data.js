...
export const data = [
  ...
  },
  {
    ...
    category: "E-Commerce",
    image: anithrift,
    url: "https://www.anithrift.com/",
    github: "https://github.com/Aaronlb912/AniThrift",
    live: true,
    color: "#c44dff",
    labelColor: "#ff6bcb",
    tags: ["TypeScript", "Supabase", "Vercel", "Stripe"],
    screenshots: [
      { src: anithrift_01, alt: "Homepage" },
      { src: anithrift_02, alt: "Seller landing" },
      { src: anithrift_03, alt: "Sign in" },
      { src: anithrift_04, alt: "Browse listings" },
      { src: anithrift_05, alt: "Figures category" },
    ],
    highlights: [
      "Pre-loved anime merch marketplace with category browse and search",
      "Free-to-list seller flows with Stripe checkout and payouts",
      "Secure messaging, seller reviews, and built-in shipping tools",
    ],
    description:
      "Anime merch marketplace for collectors. Browse pre-loved figures, manga, and apparel; list for free with Stripe payouts, secure checkout, and in-app messaging.",
  },
];
